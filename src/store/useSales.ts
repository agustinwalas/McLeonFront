...
import { ICreateSaleRequest, IUpdateSale, ISalePopulated } from "@/types/sale";
...
interface SalesState {
  ...
  createSale: (saleData: ICreateSaleRequest) => Promise<ISalePopulated>;
...
export const useSalesStore = create<SalesState>((set, get) => ({
  ...
  createSale: async (saleData: ICreateSaleRequest) => {
    set({ loading: true, error: null });
    try {
